...
MySQL - 10.1.9-MariaDB : Database - clima
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`clima` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
...
insert  into `usuarios`(`id`,`nombre`,`apellidos`,`correo`,`password`,`sup`,`tipo`,`fechaIngreso`) values (0,'Michel','Lira','michel.lira8@gmail.com','$1$$6vy9sumsKpLV7l2Dd9MzL.',0,'admin','2016-02-03 17:21:42'),(2,'Mónica','Castillo','monica.castillo@alumnos.upla.cl','$1$$6vy9sumsKpLV7l2Dd9MzL.',0,'user','2016-02-03 17:21:42'),(4,'Michel','Lira','michel.lira@alumnos.upla.cl','$1$$6vy9sumsKpLV7l2Dd9MzL.',0,'user','2016-02-03 17:21:42'),(5,'Michel','Lira','e.tupido2@gmail.com','$1$$6vy9sumsKpLV7l2Dd9MzL.',0,'user','2016-02-03 17:32:58');
