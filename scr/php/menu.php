...
<nav class="navbar navbar-default navbar-fixed-top ">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.upla.cl"><img alt="" src="scr/img/logo_upla_color.png" height="25px"></a>
        </div>
...
?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="http://www.upla.cl/facultadingenieria"><img alt="" src="scr/img/uplafi.png" height="30px"></a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="http://meteoarmada.directemar.cl"><img alt="" src="scr/img/armada.png" height="30px"></a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="http://www.conaf.cl"><img alt="" src="scr/img/conaf.png" height="30px"></a></li>
                    </ul>
                </li>
            </ul>
